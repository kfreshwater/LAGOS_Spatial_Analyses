...
#sum counts, then isolate state names and number of observations
...
#print table
knitr::kable(sum_states,col.names=c('State Name', 'Number of Observations'))
```


     
Minnesota has the most observations, at 22,022. Rhode Island has the fewest observations, at 618.
